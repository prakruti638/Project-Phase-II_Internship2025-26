...
def apply_style():
    ...
    if not light:
        ...
        st.markdown(
            ...
            /* Ensure typing text is black in the input field */
            div[data-testid="stChatInput"] textarea {
                color: #000000 !important;
            }
            /* Optional: if using st.text_input inside popover */
            ...
            .chat-container {
                ...
                box-shadow: 0 25px 60px rgba(0, 0, 0, 0.8), 0 0 20px rgba(56, 189, 248, 0.1);
                z-index: 10000;
                overflow: hidden;
            }
            .chat-header {
        ...
        st.markdown(
            ...
            /* Floating Chatbot Styles - Light Mode */
            .chatbot-bubble {
                position: fixed;
                bottom: 25px;
                left: 25px;
